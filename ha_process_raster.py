...
def process_pixel(raster_layer,  value_exp, area_exp, crsValue, disturbance = ''):
    ...
    #test:
    delete_fid.setCrs(QgsCoordinateReferenceSystem(crsValue))
    ...
    filtered_polygon.setCrs(QgsCoordinateReferenceSystem(crsValue))
    ...
    if disturbance == 'Yes':
        ...
        buffer.setCrs(QgsCoordinateReferenceSystem(crsValue))
